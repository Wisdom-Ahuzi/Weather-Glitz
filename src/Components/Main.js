...
const Main = () => {
    ...
    const handleSuggestionOne = () => {
        ...
        const base = 'https://api.weatherapi.com/v1/current.json';
        const query = `?key=${key}&q=${Object.values(suggestions)[0]}&aqi=no`;
    ...
    const handleSuggestionTwo = () => {
        ...
        const base = 'https://api.weatherapi.com/v1/current.json';
        const query = `?key=${key}&q=${suggestions.locationTwo}&aqi=no`;
    ...
    const handleSuggestionThree = () => {
        ...
        const base = 'https://api.weatherapi.com/v1/current.json';
        const query = `?key=${key}&q=${suggestions.locationThree}&aqi=no`;
    ...
    const handleSuggestionFour = () => {

        const key = '5e6ef31d15b34067b7f10936223107';

        const base = 'https://api.weatherapi.com/v1/current.json';
        const query = `?key=${key}&q=${suggestions.locationFour}&aqi=no`;
                    ...
                    <div className="inner-second">
                        ...
                        <div className="two">
                            <div className="inner-two">
                                <p onClick={handleSuggestionOne}> {suggestions.locationOne} </p>
                                <p onClick={handleSuggestionTwo}> {suggestions.locationTwo} </p>
                                <p onClick={handleSuggestionThree}>{suggestions.locationThree}</p>
                                <p onClick={handleSuggestionFour}>{suggestions.locationFour}</p>
                            </div>
                        </div>
                        <div className="three">
                            <p>Weather Details</p>
